...
import RegisterPage from '../Auth/RegisterPage/page';
...
const LandingPage = () => {
  ...
  <div id="home" className="home">
    <div className="home-content">
      <h1>Healthy Pets,<br />Happy Wallets</h1>
      <p>
        Protect their health, protect your budget. Our 'Wellness Package Plus'
        offers essential care with significant discounts on optional
  ...
  <div id="about" className="about-container">
    ...
    <div id="about-text">
      ...
      <p>
        ...
        Package Plus,' a comprehensive and affordable care option that includes
        essential preventative services like vaccinations, physical exams,
        parasite prevention, and dental cleaning, along with up to 20%
        discounts on various optional treatments, ensuring high-quality care
        without financial strain. Additionally, the clinic facilitates pet
        adoptions, connecting loving pets with their forever homes, and
        actively seeks community donations to support animal welfare and local
        shelters.
      </p>
      <a href="#pets">
